        ...
        <section className='flex fixed bg-transparent justify-between w-full h-24 items-center'>
            ...
            <nav className="flex w-full justify-end">
                <ul className="flex justify-between primaryColor text-2xl font-extrabold">
                    ...
                    <a href="#Tecnologies"><li className="hover:text-white cursor-pointer pr-6">Tech</li></a>
                    <a href="#Projects"><li className="hover:text-white cursor-pointer pr-6">Projects</li></a>
                    <a href="#About"><li className="hover:text-white cursor-pointer pr-6">About</li></a>
                    <li className="hover:text-white cursor-pointer pr-6">Contact</li>
                </ul>
            </nav>
        </section>
    )
