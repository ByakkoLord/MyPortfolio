    ...
    return (
        <section className='flex fixed bg-transparent justify-between w-full h-24 items-center'>
            ...
            <nav className="flex w-full justify-end">
                <i onClick={() => {setShow(!show)}} className="md:hidden
                text-3xl transition-all mr-10 hover:bg-slate-600 rounded-full flex items-center justify-center w-12 h-12 primaryColor fa-solid fa-bars"></i>
