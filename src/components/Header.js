...
function Header() {
    ...
    return (
        <section className='flex fixed bg-transparent justify-between w-full h-24 items-center'>
            <div className="flex w-full"><i id="logo_icon" onClick={Alternate} className="hover:cursor-pointer hover:scale-110 transition-all fa-solid fa-power-off primaryColor text-5xl ml-12"/></div>
